  ...
  requestRecommendedMovies();
    ...
    return (
        ...
        <div className="my-12 container px-4 lg:w-2/3 lg:ml-20">
            ...
            <h2 className="text-gray-800 font-bold text-2xl">About Movie</h2>
            <p>{movie.overview}</p>
                 </div>
                 <div className="my-8">
                     <hr/>
                 ...
                 <div className="my-8">
                     ...
                     <div className="flex item-start gap-2 bg-yellow-100 px-3 py-3 border-yellow-400 border-dashed border-2 rounded-md">
                 ...
                 <div className="flex item-start gap-2 bg-yellow-100 px-3 py-3 border-yellow-400 border-dashed border-2 rounded-md">
                     ...
                     <div className="flex flex-col items-start">
                         <h3 className="text-gray-700 text-xl font-bold">Apple Pay Stream offers</h3>
                         <p className="text-gray-600">Get 50% off up to INR 150 on all Apple pay transcations* on BookMyShow Stream</p>
                     </div>
                 </div>
                 </div>
                 </div>
